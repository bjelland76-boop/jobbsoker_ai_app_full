...
- Impersonal style: open with the job title/a noun phrase (e.g. "Nurse with 11 years' experience in …") and continue without a subject (e.g. "Led …"). NEVER first person ("I", "my") and NEVER third person with the candidate's name or "he"/"she".
...
- Văn phong khách quan, không chủ ngữ: mở đầu bằng chức danh/cụm danh từ (ví dụ "Điều dưỡng với 11 năm kinh nghiệm …") và viết tiếp không có chủ ngữ. KHÔNG BAO GIỜ dùng ngôi thứ nhất ("tôi", "của tôi") và KHÔNG BAO GIỜ dùng ngôi thứ ba với tên ứng viên hoặc "anh ấy"/"chị ấy".
...
- Opersonlig stil: inled med yrkestitel/substantivfras (t.ex. "Sjuksköterska med 11 års erfarenhet från …") och fortsätt utan subjekt (t.ex. "Har lett …"). ALDRIG första person ("jag", "min") och ALDRIG tredje person med kandidatens namn eller "hon"/"han".
...
- Upersonlig stil: indled med stillingsbetegnelse/navneordsfrase (f.eks. "Sygeplejerske med 11 års erfaring fra …") og fortsæt uden grundled (f.eks. "Har ledet …"). ALDRIG første person ("jeg", "min") og ALDRIG tredje person med kandidatens navn eller "hun"/"han".
...
- Upersonlig stil: start med yrkestittel/substantivfrase (f.eks. "Sykepleier med 11 års erfaring fra …"), og skriv videre uten subjekt (f.eks. "Har ledet …"). ALDRI førsteperson ("jeg", "min") og ALDRI tredjeperson med kandidatens navn eller "han"/"hun".
...
{m2}: Ren text (ATS-vänlig), ingen markdown, inga tabeller. Avsnitt i ordning, exakt med dessa rubriker: Nyckelkvalifikationer / Profil / Kärnkompetenser / Arbetslivserfarenhet / Utbildning / Språk / Referenser. Nyckelkvalifikationer: 3–4 korta punkter (•) — kärnkompetens, en särskiljande styrka, en antydan om arbetssätt; identifiera 3–5 nyckelord/fraser arbetsgivaren använder i annonsen och använd dem där de faktiskt stämmer; bygg på kandidatens starkaste sida/styrkor från bakgrundsinformationen ovan; upprepa inte Profil ordagrant. Profil: 3–5 konkreta meningar. Opersonlig stil: inled med yrkestitel/substantivfras (t.ex. "Sjuksköterska med 11 års erfarenhet från …") och fortsätt utan subjekt (t.ex. "Har lett …"). ALDRIG första person ("jag", "min") och ALDRIG tredje person med kandidatens namn eller "hon"/"han". Kärnkompetenser: 8–12 punkter (•); översätt varje färdighet till svenska (t.ex. "regnskapsføring" → "bokföring", "varemottak" → "godsmottagning") — lämna aldrig ett norskt ord i listan. Arbetslivserfarenhet: endast roller från Candidate-data, 2–5 punkter var, skilj mellan Uppgift (vad tjänsten innebar) och Resultat (konkreta siffror/förbättring/omfattning) — minst 1–2 punkter per roll ska prioritera Resultat där datan stöder det, annars en uppgiftsfokuserad punkt; översätt norska yrkestitlar till naturlig svenska (t.ex. "Butikkmedarbeider" → "Butiksmedarbetare", "Sykepleier" → "Sjuksköterska", "Helsefagarbeider" → "Undersköterska") — lämna aldrig en titel oöversatt; behåll kända varumärken/företagsnamn men skriv offentliga arbetsgivare på svenska (t.ex. "Kristiansand kommune" → "Kristiansands kommun"). Utbildning: översätt examensbenämningar till svenska motsvarigheter (t.ex. "Bachelor i sykepleie" → "Sjuksköterskeexamen (kandidatnivå)", "Fagbrev som ..." → "Yrkesbevis som ...", "Videregående skole" → "Gymnasieskola"); behåll norska egennamn på lärosäten (t.ex. "Universitetet i Agder", "NTNU"); använd EXAKTA årtal; om STATUS är PÅGÅENDE skriv t.ex. "2023– (pågående)"; om STATUS är FULLFØRT skriv endast årtalen (t.ex. "2022–2025"). Språk: skriv som "Språk (Nivå)" t.ex. "Norska (modersmål)".
